...
public class DefaultAccountForm extends JDialog {
    ...
    public DefaultAccountForm() {
        ...
        setSize(340, 350);
        setVisible(false);
        JRadioButton_Chk.setText("Default");
        JRadioButton_Chk.setActionCommand("Default");
    ...
    void JButtonOK_actionPerformed(ActionEvent event) {
        ...
        AccountNumber = Integer.parseInt(JTextField_ACNR.toString());
        name = JTextField_NAME.toString();
        street = JTextField_STR.toString();
        city = JTextField_CT.toString();
    }
